...
// 2023-01-17 16:55:34.352793 -0500 EST m=+0.042751210
package docs
...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.PermissionTokenRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controllers.PermissionTokenResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        "controllers.PermissionTokenRequest": {
            "type": "object",
            "properties": {
                "nftContractAddress": {
        ...
        "controllers.PermissionTokenResponse": {
            "type": "object",
            "properties": {
                "token": {
                    "type": "string"
